...
class LoginPage extends ConsumerStatefulWidget {
  ...
  const LoginPage({super.key, required this.onNavigateToSignup});
    ...
    ref.listen(authControllerProvider, (_, next) {
      if (next.hasError) {
        ...
        if (error?.code == 'user-not-found') {
          _showThemedError('Account not found. Redirecting to Sign Up...');
          Future.delayed(const Duration(seconds: 1), widget.onNavigateToSignup);
        } else {
          _showThemedError(error?.message ?? 'Authentication failed');
        }
      }
    });
            ...
            child: Column(
              ...
              children: [
                ...
                FadeInSlide(
                  ...
                  child: Text('Sign in to track your expenses',
